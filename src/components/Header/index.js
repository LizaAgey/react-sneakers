...
function Header(props) {
    ...
    const {totalCartPrice} = useCartItems()
    ...
    return (
        <header className="d-flex justify-between	align-center p-40">
            ...
            <ul className="d-flex">
                <li data-tip data-for="cartTip" className="mr-30 d-flex align-center cu-p" onClick={props.onClickCart}>
                    ...
                    <span className="ml-10 ">{totalCartPrice} USD</span>
                ...
                <li data-tip data-for="ordersTip" className="ml-10">
                    <Link to="/orders">
                ...
                <ReactTooltip id="favsTip" place="top" effect="solid">
                    <p>Favs</p>
                </ReactTooltip>
            </ul>
        </header>
