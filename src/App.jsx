        ...
        <div className="wrapper clear">
            ...
            <header className="d-flex justify-between	align-center p-40">
                ...
                <div className="overlay">
                    <div className="right-menu">
                        ...
                        <div className="right-total d-flex flex-column m-30">
                            ...
                            <button className="d-flex justify-center align-center p-20">
                                <h3>Make an order</h3>
                ...
                <ul className="headerRight d-flex">
                    <li className="mr-30 d-flex align-center">
                        ...
                        <span className="ml-10">130 USD</span>
                    </li>
                    <li>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="content p-40">
                ...
                <div className="card-wrapper d-flex justify-between">
                    ...
                    <div className="card d-flex flex-column align-center ">
                        <img className="sneaker-img" src="/img/sneakers/2.jpg" alt="sneaker"/>
                        <h5>Man Sneakers Nike Blazer Mid Suede</h5>
                    ...
                    <div className="card d-flex flex-column align-center ">
                        <img className="sneaker-img" src="/img/sneakers/3.jpg" alt="sneaker"/>
                        <h5>Man Sneakers Nike Blazer Mid Suede</h5>
                    ...
                    <div className="card d-flex flex-column align-center ">
                        <img className="sneaker-img" src="/img/sneakers/4.jpg" alt="sneaker"/>
                        <h5>Man Sneakers Nike Blazer Mid Suede</h5>
